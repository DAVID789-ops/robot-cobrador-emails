...
print("Envío de correos en ingles ----------------------")
...
#     //////////////////     aqui empieza el IDIOMA ingles -----------------------
#
#
#
# intensidad 1 ingles 3 dias a la semana
    ...
    if dia_semana in [0, 2, 4]:
        ...
        try:
            ...
            for deuda in deudas:
                ...
                # Verificar las condiciones para enviar el correo (intensidad 2, ingles, tiempo 3)
                if intensidad == 1 and idioma.lower() == "ingles" and tiempo == 3 and cobrar == True:
                    
                    # Crear el mensaje del correo
                    mensaje = MIMEMultipart()
                    mensaje["From"] = EMAIL_CONFIG["USER"]
                    mensaje["To"] = email_contacto
                    mensaje["Subject"] = f"Pending Payment Reminder - {nombre_colegio}"

                    # Cargar el contenido HTML del correo
                    with open("emails/templates/ingles/1/carta.html", "r", encoding="utf-8") as f:
                        html = f.read().format(
                    ...
                    with open("emails/templates/ingles/1/logo.png", "rb") as img:
                        logo = MIMEImage(img.read())
                        logo.add_header("Content-ID", "<logo>")
                        mensaje.attach(logo)

                    # Adjuntar la imagen del pie de página
                    with open("emails/templates/ingles/1/footer_image.png", "rb") as img:
...
# intensidad 1 ingles 2 dias a la semana EXPAÑOL
    ...
    if dia_semana in [0, 3]:
        ...
        try:
            ...
            for deuda in deudas:
                ...
                # Verificar las condiciones para enviar el correo (intensidad 1, ingles, tiempo 2)
                if intensidad == 1 and idioma.lower() == "ingles" and tiempo == 2 and cobrar == True:
...
# intensidad 1 ingles 1 dia a la semana EXPAÑOL TIEMPO 1
    ...
    if dia_semana == 0:
        ...
        try:
            ...
            for deuda in deudas:
                ...
                # Verificar las condiciones para enviar el correo (intensidad 1, ingles, tiempo 2)
                if intensidad == 1 and idioma.lower() == "ingles" and tiempo == 1 and cobrar == True:
...
#
# intensidad 2 ingles 3 dias a la semana
    # Verificar si es lunes, miércoles o viernes (0, 2, 4)
    if dia_semana in [0, 2, 4]:
        print("Hoy es lunes, miércoles o viernes. Se procederá con el tercer intento.")
        ...
        try:
            ...
            for deuda in deudas:
                ...
                # Verificar las condiciones para enviar el correo (intensidad 2, ingles, tiempo 3)
                if intensidad == 2 and idioma.lower() == "ingles" and tiempo == 3 and cobrar == True:
                    ...
                    # Cargar el contenido HTML del correo
                    with open("emails/templates/ingles/2/carta.html", "r", encoding="utf-8") as f:
                        html = f.read().format(
                            nombre_colegio=nombre_colegio,
                            cantidad_deuda=cantidad_deuda,
                            producto_entregado=producto_entregado,
                    ...
                    # Adjuntar el logo al correo
                    with open("emails/templates/ingles/2/logo.png", "rb") as img:
                        logo = MIMEImage(img.read())
                        logo.add_header("Content-ID", "<logo>")
                        mensaje.attach(logo)

                    # Adjuntar la imagen del pie de página
                    with open("emails/templates/ingles/2/footer_image.png", "rb") as img:
                        footer_image = MIMEImage(img.read())
                        footer_image.add_header("Content-ID", "<footer_image>")
                        mensaje.attach(footer_image)
...
# intensidad 2 ingles 2 dias a la semana EXPAÑOL
    ...
    if dia_semana in [0, 3]:
        ...
        try:
            ...
            for deuda in deudas:
                ...
                # Verificar las condiciones para enviar el correo (intensidad 2, ingles, tiempo 2)
                if intensidad == 2 and idioma.lower() == "ingles" and tiempo == 2 and cobrar == True:
...
# intensidad 2 ingles 1 dia a la semana EXPAÑOL TIEMPO 1
    ...
    if dia_semana == 0:
        ...
        try:
            ...
            for deuda in deudas:
                ...
                # Verificar las condiciones para enviar el correo (intensidad 2, ingles, tiempo 2)
                if intensidad == 2 and idioma.lower() == "ingles" and tiempo == 1 and cobrar == True:
