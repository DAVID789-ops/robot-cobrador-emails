    ...
    if dia_semana in [0, 2, 4]:
        ...
        try:
            ...
            for deuda in deudas:
                ...
                if intensidad == 1 and idioma.lower() == "ingles" and tiempo == 3:
    ...
    if dia_semana in [0, 3]:
        ...
        try:
            ...
            for deuda in deudas:
                ...
                if intensidad == 1 and idioma.lower() == "ingles" and tiempo == 2:
    ...
    if dia_semana == 0:
        ...
        try:
            ...
            for deuda in deudas:
                ...
                # Verificar las condiciones para enviar el correo (intensidad 1, ingles, tiempo 2)
                if intensidad == 1 and idioma.lower() == "ingles" and tiempo == 1:
    ...
    if dia_semana in [0, 2, 4]:
        ...
        try:
            ...
            for deuda in deudas:
                ...
                # Verificar las condiciones para enviar el correo (intensidad 2, ingles, tiempo 3)
                if intensidad == 2 and idioma.lower() == "ingles" and tiempo == 3:
    ...
    if dia_semana in [0, 3]:
        ...
        try:
            ...
            for deuda in deudas:
                ...
                if intensidad == 2 and idioma.lower() == "ingles" and tiempo == 2:
    ...
    if dia_semana == 0:
        ...
        try:
            ...
            for deuda in deudas:
                ...
                # Verificar las condiciones para enviar el correo (intensidad 2, ingles, tiempo 2)
                if intensidad == 2 and idioma.lower() == "ingles" and tiempo == 1:
