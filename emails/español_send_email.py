...
print("Envío de correos en expañol ----------------------")
...
#     //////////////////     aqui empieza el IDIOMA ESPAÑOL -----------------------
#
#
#
# intensidad 1 español 3 dias a la semana
        ...
        try:
            ...
            for deuda in deudas:
                ...
                if intensidad == 1 and idioma.lower() == "espanol" and tiempo == 3 and cobrar == True:
                    ...
                    with open("emails/templates/español/1/carta.html", "r", encoding="utf-8") as f:
                        html = f.read().format(
                    ...
                    with open("emails/templates/español/1/logo.png", "rb") as img:
                        logo = MIMEImage(img.read())
                        logo.add_header("Content-ID", "<logo>")
                        mensaje.attach(logo)

                    # Adjuntar la imagen del pie de página
                    with open("emails/templates/español/1/footer_image.png", "rb") as img:
...
# intensidad 1 español 2 dias a la semana EXPAÑOL
...
# intensidad 1 español 1 dia a la semana EXPAÑOL TIEMPO 1
...
#
# intensidad 2 español 3 dias a la semana
    # Verificar si es lunes, miércoles o viernes (0, 2, 4)
    if dia_semana in [0, 2, 4]:
        print("Hoy es lunes, miércoles o viernes. Se procederá con el tercer intento.")
        ...
        try:
            ...
            for deuda in deudas:
                ...
                if intensidad == 2 and idioma.lower() == "espanol" and tiempo == 3 and cobrar == True:
                    ...
                    # Cargar el contenido HTML del correo
                    with open("emails/templates/español/2/carta.html", "r", encoding="utf-8") as f:
                        html = f.read().format(
                            nombre_colegio=nombre_colegio,
                            cantidad_deuda=cantidad_deuda,
                            producto_entregado=producto_entregado,
...
# intensidad 2 español 2 dias a la semana EXPAÑOL
...
# intensidad 2 español 1 dia a la semana EXPAÑOL TIEMPO 1
